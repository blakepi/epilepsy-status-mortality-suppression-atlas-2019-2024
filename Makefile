...
.PHONY: check-viz-env figures qa-figures manuscript bayes_prepare bayes_initialize bayes_fit_quick bayes_fit bayes_summarize bayes_figures bayes_manuscript bayes_validate bayes_all submission_figures submission_tables submission_manuscript submission_supplement submission_qc submission_package submission_all
