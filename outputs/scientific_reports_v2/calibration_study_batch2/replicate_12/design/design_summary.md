# Calibration batch 2, replicate 12

Scenario: `baseline_rate_3_4_kappa_4`

| Quantity | Value |
| --- | ---: |
| Baseline rate per 100,000 | 3.40 |
| NB2 kappa | 4.00 |
| County-year rows | 432 |
| Exact cells | 40 |
| Suppressed 1–9 cells | 198 |
| Zero cells | 194 |
| Suppressed fraction | 0.4583 |
| Minimum pairwise start L1 distance | 282 |
| Design status | PASS |
