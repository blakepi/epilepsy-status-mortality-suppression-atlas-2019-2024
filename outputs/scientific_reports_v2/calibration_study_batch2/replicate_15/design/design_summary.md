# Calibration batch 2, replicate 15

Scenario: `higher_rate_5_0_kappa_10`

| Quantity | Value |
| --- | ---: |
| Baseline rate per 100,000 | 5.00 |
| NB2 kappa | 10.00 |
| County-year rows | 432 |
| Exact cells | 49 |
| Suppressed 1–9 cells | 241 |
| Zero cells | 142 |
| Suppressed fraction | 0.5579 |
| Minimum pairwise start L1 distance | 396 |
| Design status | PASS |
