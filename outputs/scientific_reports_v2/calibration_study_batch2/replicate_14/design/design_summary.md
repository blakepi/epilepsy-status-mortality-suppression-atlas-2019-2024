# Calibration batch 2, replicate 14

Scenario: `lower_rate_2_4_kappa_10`

| Quantity | Value |
| --- | ---: |
| Baseline rate per 100,000 | 2.40 |
| NB2 kappa | 10.00 |
| County-year rows | 432 |
| Exact cells | 35 |
| Suppressed 1–9 cells | 191 |
| Zero cells | 206 |
| Suppressed fraction | 0.4421 |
| Minimum pairwise start L1 distance | 180 |
| Design status | PASS |
