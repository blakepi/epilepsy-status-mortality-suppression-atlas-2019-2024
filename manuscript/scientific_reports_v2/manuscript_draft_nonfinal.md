...
This ecological study used public aggregate mortality and county covariate data. The outcome was any mention of ICD-10 G40 (epilepsy and recurrent seizures) or G41 (status epilepticus) on a U.S. death certificate in the CDC WONDER Multiple Cause of Death, 2018–2024 Single Race database, restricted tۭ��G����ƭy�Counties without direct covariate matches were retained to preserve public-total reconciliation and imputed according to the frozen processing rules documented in the repository.
