...
We are pleased to submit this draft manuscript, "Suppression-aware county-level epilepsy and status epilepticus mortality in the United States, 2019-2024," for consideration after journal-specific formatting is completed.
...
This draft has not yet been formatted for a specific journal and does not include final author metadata, reference verification, or submission declarations. Those elements should be completed in Phase 12.
